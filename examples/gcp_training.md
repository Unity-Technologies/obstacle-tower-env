...
```bash
wget https://storage.googleapis.com/obstacle-tower-build/v3.0/obstacletower_v3.0_linux.zip
unzip obstacletower_v3.0_linux.zip
```
...
If you didn’t extract the `obstacletower_v3.0_linux.zip` to the home directory, you will need to edit `rainbow_otc.gin`, specifically `create_otc_environment.environment_path` should correspond to the path to your extracted OTC executable file. 
